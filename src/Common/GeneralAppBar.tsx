import {AppBar, Button, styled, Switch, Toolbar, Typography} from "@mui/material";
...
export const DarkThemeSwitch = styled(Switch)(({theme}) => ({
    ...
    '& .MuiSwitch-thumb': {
        backgroundColor: theme.palette.mode === 'dark' ? '#d50000' : '#fff',
        width: 32,
        height: 32,
        '&:before': {
            content: "''",
...
export default function GeneralAppBar() {
    ...
    const handleThemeChange = (event: ChangeEvent<HTMLInputElement>, checked: boolean) => {
        ...
        //localStorage.setItem("useDarkTheme", checked ? "true": "");

    }

    return (
        <AppBar color={"primary"} position="static" sx={{mb: 3}}>
            <Toolbar>
